...
exports.postdeleteproduct = (req, res, next) => {
  ...
  if (productid) {
    ...
    .then(result =>  {
      console.log((result.acknowledged ? 'DELETED PRODUCT IS DONE!!' : 'Occoured Error !') + ' (this in AdminController Func Post Delete)');
      res.redirect('/');
    })
    .catch(err => {
      console.log(err);
...
exports.postAddProduct = (req, res) => {
  ...
  addproduct.save()
  .then(result => {
    console.log((result.acknowledged ? 'Added Successful !' : 'Occoured Error !') + ' (this in AdminController Func Post add)');
    res.redirect('/')
  })
...
exports.postEditeProduct = (req, res) => {
  ...
  .then(result => {
    console.log((result.acknowledged ? 'Update Successful !' : 'Occoured Error !') + ' (this in AdminController Func Post edit)');
  })
  .catch(err => console.log(err));
  res.redirect('/');    
};